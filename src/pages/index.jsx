...
`;
const orange = 'linear-gradient(to right, #D4145A 0%, #FBB03B 100%)';
const pink = 'linear-gradient(to right, #662D8C 0%, #ED1E79 100%)';
const green = 'linear-gradient(to right, #009245 0%, #FCEE21 100%)';
const blue = 'linear-gradient(to right, #D585FF 0%, #00FFEE 100%)';

const Index = () => (
  <React.Fragment>
    <SEO />
    <Parallax pages={6.25}>
      <Divider speed={0.2} offset={0} factor={1.5}>
        <UpDown>
          <SVG
            icon='triangle'
            className={hidden}
      ...
      <DividerMiddle
        ...
        factor={2}
      />
      <Content speed={0.4} offset={2} factor={1}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            <ProjectCard
              title='Pumsy Bank'
              link='https://github.com/Jameson13B/pumsy-bank'
              bg={orange}
            >
              A point/bank system for teachers to use with their students.
              Teachers can give or take points (unopinionated currency) for
              various reasons to be redeemed for rewards or prizes. Built using
              a Node GraphQL server, Postgres database, and Prisma as an ORM.
              Project is currently in production and is not yet deployed.{' '}
              <strong>(Current Project)</strong>
              <br />
              <br />
              <a
                href='https://github.com/Jameson13B/pumsy-bank'
                target='_blank'
      ...
      <Divider speed={0.2} offset={1.5} factor={2}>
        <UpDown>
      ...
      <Divider fill='#23262b' speed={0.2} offset={5.3}>
        <WaveWrapper>
          <InnerWave>
            <svg
